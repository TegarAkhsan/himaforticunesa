...
@section('content')
    ...
    <div class="bg-gradient-to-br from-blue-800 to-blue-950 text-white relative overflow-hidden">
        ...
        <div class="absolute inset-0 z-0 opacity-10"
            style="background-image: url('data:image/svg+xml,%3Csvg width=\'100\' height=\'100\' viewBox=\'0 0 100 100\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Ccircle cx=\'50\' cy=\'50\' r=\'10\' fill=\'%23ffffff\' fill-opacity=\'0.05\'/%3E%3C/svg%3E'); background-size: 20px 20px;">
        </div>
    ...
    @if($periode)
        <section class="py-16 bg-gradient-to-b from-white to-blue-50/30">
            <div class="max-w-6xl mx-auto px-4 text-center">
                <div class="mb-8">
                    <h2
                        class="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-800 to-cyan-700 bg-clip-text text-transparent mb-3">
                    ...
                    <div class="text-center group">
                        <div class="relative inline-block mb-3">
                            @if($periode->ketua && $periode->ketua->foto)
                                <div
                                    class="absolute -inset-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full blur opacity-25 group-hover:opacity-50 transition duration-300">
                                </div>
                                <img src="{{ asset('storage/' . $periode->ketua->foto) }}" alt="Chairman"
                            ...
                            @else
                                <div
                                    class="w-20 h-20 rounded-full bg-gradient-to-br from-blue-400 to-cyan-400 flex items-center justify-center text-white shadow-md">
                        ...
                        <p
                            class="text-xs bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent font-medium mt-1">
                            Ketua Himpunan</p>
                    </div>
                    ...
                    <div class="text-center group">
                        <div class="relative inline-block mb-3">
                            @if($periode->wakil && $periode->wakil->foto)
                                <div
                                    class="absolute -inset-2 bg-gradient-to-r from-cyan-400 to-blue-400 rounded-full blur opacity-25 group-hover:opacity-50 transition duration-300">
                                </div>
                                <img src="{{ asset('storage/' . $periode->wakil->foto) }}" alt="Vice Chairman"
                                    class="relative w-20 h-20 rounded-full object-cover border-2 border-white shadow-md z-10 transform group-hover:scale-105 transition duration-300">
                            @else
                                <div
                                    class="w-20 h-20 rounded-full bg-gradient-to-br from-cyan-400 to-blue-400 flex items-center justify-center text-white shadow-md">
                                    <i class="fas fa-user text-lg"></i>
                                </div>
                            @endif
                        </div>
                        ...
                        <p
                            class="text-xs bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text text-transparent font-medium mt-1">
                            Wakil Ketua Himpunan</p>
                    </div>
                </div>
                ...
                @if($periode->foto || $periode->deskripsi)
                    <div
                        class="max-w-5xl mx-auto text-left text-slate-700 leading-relaxed bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-blue-100/50">
                        @if($periode->foto)
                            <div class="relative float-right ml-6 mb-4 group">
                                <div
                                    class="absolute -inset-2 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-lg blur opacity-25 group-hover:opacity-50 transition duration-300">
                                </div>
                                <img src="{{ asset('storage/' . $periode->foto) }}" alt="Period Photo {{ $periode->tahun_periode }}"
    ...
    <section class="py-16 bg-gradient-to-b from-slate-50 to-blue-50/50 border-t border-blue-100/40">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12">
                ...
                <h2
                    class="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-800 to-cyan-700 bg-clip-text text-transparent mb-4">
                    ...
                    <div
                        ...
                        <div class="p-4 text-center">
                            ...
                            <a href="{{ url('/departemen/' . $item->slug) }}"
                                ...
                                <span>Detail</span>
                                <i
                                    class="fas fa-arrow-right group-hover/btn:translate-x-1 transition-transform duration-300 text-[10px]"></i>
                            </a>
                        </div>
                    </div>
                @endforeach
