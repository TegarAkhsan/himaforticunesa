    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <main class="lg:col-span-3">
                <article class="bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden transition-all duration-300 hover:shadow-3xl">
                    ...
                    <header class="relative p-8 border-b border-slate-100">
                        ...
                        <div class="flex items-center gap-6 text-slate-600 text-sm">
                            <div class="flex items-center gap-2">
                                <div class="w-8 h-8 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full flex items-center justify-center text-white text-xs font-bold">
                    ...
                    <section class="p-8 prose prose-lg max-w-none">
                        ...
                        <div class="mt-8 pt-6 border-t border-slate-100">
                            <div class="flex flex-wrap gap-2">
                                ...
                                <span class="bg-slate-100 text-slate-700 px-3 py-1 rounded-full text-sm hover:bg-blue-100 hover:text-blue-700 transition-colors cursor-pointer">
                                    #{{ $tag }}
                                </span>
                                @endforeach
                            </div>
                            ...
                            <a href="{{ route('berita.show', $item) }}" 
                               class="group block p-4 hover:bg-blue-50 rounded-xl transition-all duration-300 border-b border-slate-100 last:border-b-0">
                                <div class="flex gap-4">
                                    ...
                                    @else
                                    <div class="flex-shrink-0 w-20 h-20 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-xl flex items-center justify-center text-white shadow-md">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h4 class="font-semibold text-slate-800 group-hover:text-blue-700 transition-colors line-clamp-2 leading-tight mb-2">
                                            {{ $item->judul }}
                                        </h4>
